...
Paper referenced from “Weight of horses: improved estimates based on
girth and length.” (Milner and Hewitt 1969)

## Results

<div class="figure">

<img src="hist_horse_pop_files/figure-gfm/plot horses-1.png" alt="Figure 1. Historic number of horses for all province in Canada between 1940 to 1972" width="100%" />

<p class="caption">

Figure 1. Historic number of horses for all province in Canada between
1940 to 1972
...
<img src="hist_horse_pop_files/figure-gfm/plot province-1.png" alt="Figure 2. Historic number of horses for province of focus" width="50%" />

<p class="caption">

Figure 2. Historic number of horses for province of focus
