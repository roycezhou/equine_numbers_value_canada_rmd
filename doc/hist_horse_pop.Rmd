...
Paper referenced from "Weight of horses: improved estimates based on girth and length." [@milner1969weight]


## Results

```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Historic number of horses for all province in Canada between 1940 to 1972", out.width="100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Historic number of horses for province of focus", out.width="50%"}
